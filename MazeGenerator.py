...
if len(sys.argv) != 4:
    print("Usage:python MazeGenerator.py width hight output_file_name")
else:
...
def wall_matrix(width,height,filename):
    
    gd = grid(width,height)
...
try:
    ...
    wall_matrix(width,height,filename)
    print("Your File is Ready!!!")

except:

    print("Read the usage or invalid parameters")
